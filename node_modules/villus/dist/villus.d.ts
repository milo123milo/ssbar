...
declare const Query: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            variables?: unknown;
            cachePolicy?: unknown;
            watchVariables?: unknown;
            suspended?: unknown;
            fetchOnMount?: unknown;
        } & {
            suspended: boolean;
            query: unknown;
            fetchOnMount: boolean;
        ...
        $forceUpdate: vue.ReactiveEffect<any>;
...
declare const Subscription: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            reduce?: Function;
            variables?: Record<string, any>;
        }> & {} & vue.VNodeProps & vue.AllowedComponentProps & vue.ComponentCustomProps, "paused" | "reduce" | "variables">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
...
declare function useSubscription<TData = any, TResult = TData, TVars = QueryVariables>({ query, variables, paused }: SubscriptionCompositeOptions<TData, TVars>, reduce?: Reducer<TData, TResult>): {
...
export { AfterQueryCallback, CachePolicy, Client, ClientPlugin, ClientPluginContext, ClientPluginOperation, CombinedError, MaybeRef, Mutation, ObservableLike, ObserverLike, OperationResult, OperationType, OperationWithCachePolicy, Provider, Query, QueryExecutionContext, QueryVariables, StandardOperationResult, Subscription, SubscriptionForwarder, Unsubscribable, VILLUS_CLIENT, cache, createClient, dedup, defaultPlugins, definePlugin, fetch, getQueryKey, handleSubscriptions, useClient, useMutation, useQuery, useSubscription, withProvider };
